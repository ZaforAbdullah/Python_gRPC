...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BOOKSEARCH']._serialized_end=114
  _globals['_BOOKSTORE']._serialized_start=116
  _globals['_BOOKSTORE']._serialized_end=196
